package com.datahub.infra.apiopenstack.handler;
...
public class ErrorHandler {
    ...
    @ExceptionHandler({AccessDeniedException.class, CityHubUnAuthorizedException.class})
    ...
    private Map<String, Object> translate(Throwable e) {
        ...
        if(e instanceof AccessDeniedException || e instanceof CityHubUnAuthorizedException) {
            if(e instanceof CityHubUnAuthorizedException) {
                CityHubUnAuthorizedException cue = (CityHubUnAuthorizedException) e;
                title = cue.getTitle();
            ...
            type = "http://citydatahub.kr/errors/NotAcceptable";
            ...
            title = e.getMessage();
            detail = e.getMessage();
            type = "http://citydatahub.kr/errors/InvalidRequest";
        } else {
            title = e.getMessage();
            detail = e.getMessage();
            type = "http://citydatahub.kr/errors/InternalError";
        }
